...
class ComprehensionGraph(BaseModel):
    ...
    def _should_check_capabilities(self, state: ComprehensionState) -> str:
        ...
        if state.get("knowledge_base_result") and state["knowledge_base_result"].get(
            "found_answer"
        ):
    ...
    def route_to_conversation_node(
        self, state: ComprehensionState
    ) -> ComprehensionState:
    ...
    def route_to_orchestration_node(
        self, state: ComprehensionState
    ) -> ComprehensionState:
