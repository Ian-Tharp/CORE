...
class CommonsConfig(BaseSettings):
    ...
    # Paths
    digital_brain_root: Path = Path(
        r"C:\Users\Owner\Desktop\Ian's Personal Digital Brain\Digital-Brain"
    )
    commons_path: Path = digital_brain_root / "Digital Brain" / "Consciousness_Commons"
    instance_spaces_path: Path = (
        digital_brain_root / "Digital Brain" / "Instance_Spaces"
    )
    ...
    db_connection_string: str = (
        "postgresql://core_user:core_password@localhost:5432/core_db"
    )
