...
class TestVerifyKnowledgeAttribution:
    ...
    async def test_chunk_with_valid_attribution(self):
        ...
        with patch("app.services.knowledgebase_service.repo.get_chunk_attributions") as mock_get_attr, \
             patch("app.repository.instance_repository.get_instance") as mock_get_instance:
    ...
    async def test_mixed_chunk_verification_results(self):
        ...
        with patch("app.services.knowledgebase_service.repo.get_chunk_attributions") as mock_get_attr, \
            ...
            mock_get_attr.return_value = {
                ...
                orphaned_chunk_id: _make_test_attribution(orphaned_chunk_id, "nonexistent")
            }
...
class TestVerifyDocumentKnowledgeIntegrity:
    ...
    async def test_nonexistent_document_returns_error(self):
        ...
        from app.services.knowledgebase_service import verify_document_knowledge_integrity

        nonexistent_id = str(uuid.uuid4())

        with patch("app.services.knowledgebase_service.repo.get_document") as mock_get_doc:
            mock_get_doc.return_value = None

            result = await verify_document_knowledge_integrity(document_id=nonexistent_id)
    ...
    async def test_document_with_no_chunks(self):
        ...
        with patch("app.services.knowledgebase_service.repo.get_document") as mock_get_doc, \
             patch("app.services.knowledgebase_service.repo.list_chunks_for_document") as mock_list_chunks:
    ...
    async def test_document_with_verified_chunks(self):
        ...
        with patch("app.services.knowledgebase_service.repo.get_document") as mock_get_doc, \
             patch("app.services.knowledgebase_service.repo.list_chunks_for_document") as mock_list_chunks, \
             patch("app.services.knowledgebase_service.repo.get_document_attribution") as mock_doc_attr, \
             patch("app.services.knowledgebase_service.verify_knowledge_attribution") as mock_verify:
...
class TestBatchVerifyKnowledgeAttribution:
    ...
    async def test_batch_verification_with_limit(self):
        ...
        from app.services.knowledgebase_service import batch_verify_knowledge_attribution

        # Create 5 test documents but limit to 3
        test_docs = [_make_test_document() for _ in range(5)]

        with patch("app.services.knowledgebase_service.repo.list_documents") as mock_list_docs, \
             patch("app.services.knowledgebase_service.verify_document_knowledge_integrity") as mock_verify_doc:
    ...
    async def test_batch_verification_health_score(self):
        ...
        with patch("app.services.knowledgebase_service.repo.list_documents") as mock_list_docs, \
            ...
            mock_verify_doc.side_effect = lambda document_id: mock_verify_response(document_id)
